<aside class="control-sidebar control-sidebar-light">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="control-sidebar-settings-tab">
            <form method="post" action="{{ route('store.users.settings') }}">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <label class="control-sidebar-subheading">
                        Notify
                        <input type="checkbox" name="notify" class="pull-right" {{ auth()->user()->notify == true ? "checked" : ""}}>
                    </label>
                    
                    <p>If you want to get emails</p>
                </div>
                <!-- /.form-group -->
